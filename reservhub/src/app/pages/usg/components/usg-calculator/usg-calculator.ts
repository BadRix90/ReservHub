...
import { USG_CALCULATOR } from '../../../../models/texts';
...
@Component({
  ...
  templateUrl: './usg-calculator.html',
  styleUrl: './usg-calculator.scss'
})
export class UsgCalculator {
  protected readonly texts = USG_CALCULATOR;
  protected readonly usgForm: FormGroup;
  protected readonly berechnungsErgebnis = signal<Berechnung>({ 
    mindestleistung: 76.85, 
    dienstleistungspraemie: 18.82, 
    gesamt: 95.67 
  });
  ...
  private readonly praemien: Praemie = {
    1: 18.82, 2: 20.67, 3: 21.59, 4: 23.45, 5: 24.06, 6: 24.38,
    7: 24.68, 8: 25.29, 9: 25.91, 10: 26.52, 11: 27.15, 12: 27.77, 13: 29.00
  };
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.usgForm.valueChanges.subscribe(() => this.berechneVerguetung());
    this.usgForm.get('berechnungsArt')?.valueChanges.subscribe((art) => this.toggleBerechnungsArt(art));
  ...
  private berechneVerguetung(): void {
    ...
    const anzahlKinder = Math.min(formValues.anzahlKinder, 3);
